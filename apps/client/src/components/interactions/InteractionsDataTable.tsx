...
interface InteractionsDataTableProps<TData, TValue> {
  columns: ColumnDef<TData, TValue>[];
  data: TData[];
}

export function InteractionsDataTable<TData, TValue>({
  columns,
  data,
}: InteractionsDataTableProps<TData, TValue>) {
  ...
  const contactFilter = (table.getColumn('contact')?.getFilterValue() as string) ?? '';
